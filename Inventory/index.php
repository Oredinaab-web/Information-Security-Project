...
<body oncontextmenu = "return false;">
    <ul>
        <li class="dropdown">
            <a href="" class="dropbtn"><img src="../Images/employee.svg" alt="ed" class="log" id="logout_user"><?php echo $_SESSION['U']; ?></a>
            <div class="dropdown-content">
                <a class="active" href="../Password/resetpassEmp.php">Change Password</a>
                <a href="http://localhost/InfoAssurance/Inventory/logout.php">Logout</a>
            </div>
    </ul>
    ...
    <form method="post" action="server.php" autocomplete="off">
        ...
        <div class="input-group">
            ...
            <input type="text" class="border" name="Emp_ID" value="<?php echo $_SESSION['U']; ?>" required readonly>
        </div>
        <div class="input-group">
        ...
        <div class="input-group">
            <label>Price</label>
            <input type="number" class="border" name="Price" onKeyPress="if(this.value.length==6) return false" onKeyPress="return blockSpecialChar(event)" value="<?php echo $Price; ?>" required>
        </div>
        <div class="input-group">
            <label>Total</label>
    ...
    <table>
        ...
        <tbody>
            <?php while($row = mysqli_fetch_array($results)){ ?>
                 ...
                 <td>
                     <a class="edit_btn" onclick="return confirm('Are you sure you want to update data?')" href="index.php?edit=<?php echo $row['id']; ?>"><img src="../Images/ed.png" alt="ed" class="ed"></a>
                 </td>
