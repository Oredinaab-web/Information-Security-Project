<?php include('EmpServerAdmin.php');
...
ini_set('display_errors', 'Off');
    ...
    if(isset($_GET['edit'])) {
        $id = $_GET['edit'];
        $edit_state = true;
        $rec = mysqli_query($db,"SELECT * FROM empreg WHERE id = $id");
...
<body oncontextmenu = "return false;">
    ...
    <?php endif ?>
    <form method="post" name="form" onsubmit="return checkForm(this)" action="EmpServerAdmin.php" autocomplete="off">
        <input type="hidden" name="id" value="<?php echo $id; ?>">
        <div class="input-group">
            <label>Admin ID</label>
            <input type="text" name="AdminId" value="<?php echo $_SESSION['SuperAdminUser']; ?>" readonly>
        </div>
        <div class="input-group">
    ...
    <table>
        ...
        <tbody>
            <?php while($row = mysqli_fetch_array($results)){ ?>
                 ...
                 <td>
                     <a class="edit_btn" onclick="return confirm('Are you sure you want to update data?')" href="EmpRegIndexAdmin.php?edit=<?php echo $row['id']; ?>"><img src="../Images/ed.png" alt="ed" class="ed"></a>
                 </td>
                 <td>
                    <a class="del_btn" onclick="return confirm('Are you sure you want to delete data?')" href="EmpServerAdmin.php?del=<?php echo $row['id']; ?>"><img src="../Images/del.png" alt="ed" class="ed"></a>
                 </td>
             </tr>
            <?php } ?>
        </tbody>
