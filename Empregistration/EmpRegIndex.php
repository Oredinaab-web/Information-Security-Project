...
<body oncontextmenu = "return false;">
    <ul>
        <li><a href="http://localhost/InfoAssurance/Empregistration/adminlogout.php">Logout</a></li>
        <li><a class="active" href="../Password/resetpassAdmin.php">Change Password</a></li>
    </ul>
    ...
    <?php endif ?>
    <form method="post" name="form" onsubmit="return checkForm(this)" action="EmpServer.php" autocomplete="off">
        <input type="hidden" name="id" value="<?php echo $id; ?>">
        <div class="input-group">
            <label>Admin ID</label>
            <input type="text" name="AdminId" value="<?php echo $_SESSION['AdminUser']; ?>" readonly>
        </div>
        <div class="input-group">
    ...
    <table>
        ...
        <tbody>
            <?php while($row = mysqli_fetch_array($results)){ ?>
                 ...
                 <td>
                     <a class="edit_btn" onclick="return confirm('Are you sure you want to update data?')" href="EmpRegIndex.php?edit=<?php echo $row['id']; ?>"><img src="../Images/ed.png" alt="ed" class="ed"></a>
                 </td>
             </tr>
            <?php } ?>
        </tbody>
